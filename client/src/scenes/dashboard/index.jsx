...
import { DownloadOutlined, Email, PointOfSale, PersonAdd, Traffic, PersonOff } from '@mui/icons-material';
      ...
      >
        ...
        >
          ...
          <Typography p="0 0.6rem" fontSize="0.8rem" sx={{color: theme.palette.secondary[200]}}>
            Breakdown of real state and informationvia category for revenue made for this year and total sales.
          </Typography>
        </Box>
      </Box>
    </Box>
